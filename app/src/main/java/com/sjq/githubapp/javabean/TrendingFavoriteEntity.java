...
public class TrendingFavoriteEntity implements Serializable {
   ...
   @Generated(hash = 879849418)
   public TrendingFavoriteEntity(Long autoId, String repo, String repo_link,
           String desc, String lang, String stars, String forks,
           String added_stars, String avatarImg) {
       this.autoId = autoId;
       this.repo = repo;
